...
const TopSec = () => {
  return (
    ...
    //   <div className='w-[100%] h-[270px] sm:min-h-[650px] flex items-center justify-around'>
    //   <Image src={bakery} alt="Hero" width={100000} height={10000} className='w-[90%] h-[90%] rounded-[60px]' />
    //   </div>
    // </section>

    <section className='py-5 bg-[var(--bg-color)] w-[100%] flex flex-col min-h-[570px]'>
